    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h4 class="page-header">All Logs</h4>
                </div>
                <!--End Page Header -->
            </div>
...
echo "<td>" . date('l d-M-Y, g:iA' , strtotime($row['actdate']))."</td>";
echo "<td>" . $row['actby'] . "</td>";
echo "</tr>";
 }
?>
