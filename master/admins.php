    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h4 class="page-header">All Administrators</h4>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					}?>				<input name="save" type="submit" class="btn btn-success" value=" Add New Admin ">
                                    </form><br>
...
while ($row = $q3->fetch()) {
echo "<tr>";
echo "<td>" . strtoupper($row['loginid'])."</td>";
echo "<td>" . $row['status'] . "</td>";
echo "<td>" . date('l d-M-Y, g:iA' , strtotime($row['logouttime']))."</td>";
?>
<td><a class="btn btn-danger" href="admin_delete.php?id=<?php echo $row["id"]; ?>" onClick="return deletevendor()">Delete</a></td>
<?php
echo "</tr>";
 }
?>
